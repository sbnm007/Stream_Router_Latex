...
% \renewcommand{\thesisauthor}{Sibin Babu George}                %% Your official TCD name.
...
% \renewcommand{\thesistitle}{A WebTransport Streams-Aware Proxy for Intra-Cluster Traffic in Kubernetes}   %% The title of your dissertation; use mixed-case.
% \renewcommand{\thesisauthorpreviousdegrees}{, Msc}    %% Your previous degrees, abbreviated; separate multiple degrees by commas.
% \renewcommand{\thesissupervisor}{Prof. Stefan Weber}            %% Your thesis supervisor; use mixed-case and don't use any titles or degrees.
...
% \emph{... and before you submit, remove the \textbackslash thesisdraft tag in the thesis.tex file!!!!}
% \end{thesisabstract}

% %\thesisdedicationpage                            %% Generate the dedication page.

% \begin{thesisacknowledgments}                     %% Use this to write your
%   Firstly I would like to take this opportunity to thank to my supervisor Prof Stefan Weber for providing me with right guidance as I navigated to explore the vast domain. I thank you again for sparking my curiosity with each meeting we had. I would also like to thank my elder sister and my mom for being there for me.%% acknowledgments; it can be anything
