...
%%%
%%
%% This file, and the corresponding tcdthesis.sty that accompanied it, have
...
\renewcommand{\thesistitle}{WebTransport Proxy Architecture over QUIC for Kubernetes}   %% The title of your dissertation; use mixed-case.
